...
const GCSOFA_PRODUCT_COPY_MAP = {
  ...
  "1357": {
    ...
    "sku": "GC-S1357",
    "category": "欧洲款式",
    "summary": "GC-S1357 是一款清新复古双人位复古沙发，采用湖蓝色柔软布艺，圆润扶手、木质高脚与明快配色营造轻松活泼的空间焦点。整体造型兼顾舒适坐感、空间秩序与长期耐看，能够与木质家具、柔和灯光及不同软装色彩自然搭配。适合家庭客厅、公寓起居区和日常会客空间，让日常休息与会客氛围更完整。",
    "tags": [
      "双人位复古沙发",
      "清新复古",
      "柔软布艺",
    ...
    "highlights": [
      "圆润扶手、木质高脚与明快配色营造轻松活泼的空间焦点，让产品从正面到侧面都保持鲜明而协调的视觉识别。",
      "湖蓝色柔软布艺带来柔和触感与稳定质感，日常使用温馨耐看。",
      "坐面、靠背与扶手关系清晰，兼顾放松体验、空间整洁和自然搭配。",
      "实景与多角度图片能够直观呈现整体轮廓、结构细节和实际家居效果。"
    ],
    "homes": [
